...
const Discord = require('discord.js'),
      ...
      Commands = require('./Commands/Database.ts'),
...
FlandreClient.on('message', async msg => {
  ...
  .get("https://nekos.life/api/v2/img/kiss")
    ...
    Flandre.messageCreate(KissEmbed, msg);
        ...
        if(!args[0]) {
          ...
          HelpEmbed.setDescription(`\`animememe, animescrap, animeavatar, neko, animebg, animemobilebg.\``)
          Flandre.messageCreate(HelpEmbed, msg);
          ...
          HelpEmbed.setDescription(`\`avatar, roles, channels, emojis, info, roleinfo, help, uptime, userinfo, serverinfo, membercount.\``)
          Flandre.messageCreate(HelpEmbed, msg);
  ...
  .get("https://nekos.life/api/v2/img/tickle")
    ...
    Flandre.messageCreate(TickleEmbed, msg);
        ...
        Flandre.logging(msg);
          const AnimeScrapError = new Flandre.flandreEmbedError().setFooter(`Anime Scrap Flandre!`, FlandreClient.user.displayAvatarURL({ dynamic: true })),
                AnimeScrapSuccess = new Flandre.flandreEmbedSuccess().setFooter(`Anime Scrap Flandre!`, FlandreClient.user.displayAvatarURL({ dynamic: true }));
         let Reply = new Object(),
             Anime = args.join(" ");
        if(!Anime) {
            AnimeScrapError.setTitle(`${FlandreUgh} | *Please Type a Anime Name!*`)
            Reply = AnimeScrapError;
            switch(Reply) {
                case AnimeScrapError:
                    Flandre.messageCreate(Reply, msg);
            }
        } else {
           AnimeScrapSuccess.setTitle(`${FlandreHi} | *Please wait!*`)
            Reply = AnimeScrapSuccess;
            switch(Reply) {
                case AnimeScrapSuccess:
                    msg.channel.send(Reply).then(msge => {
        ...
        if (!AnimeF.genres[0] || AnimeF.genres[0] === null) AnimeF.genres[0] = `None!`;
            
        AnimeScrapSuccess.setURL(AnimeF.url)
        AnimeScrapSuccess.setTitle(`${FlandreLaugh} | *${AnimeF.title}*`)
        AnimeScrapSuccess.setDescription(AnimeF.synopsis)
        AnimeScrapSuccess.addField(`Type`, `\`${AnimeF.type}\``, true)
        AnimeScrapSuccess.addField(`Status`, `\`${AnimeF.status}\``, true)
        AnimeScrapSuccess.addField(`Premiered`, `\`${AnimeF.premiered}\``, true)
        AnimeScrapSuccess.addField(`Episodes`, `\`${AnimeF.episodes}\``, true)
        AnimeScrapSuccess.addField(`Duration`, `\`${AnimeF.duration}\``, true)
        AnimeScrapSuccess.addField(`Popularity`, `\`${AnimeF.popularity}\``, true)
        AnimeScrapSuccess.addField(`Genres`, `\`${AnimeF.genres.join(", ")}\``)
        AnimeScrapSuccess.setThumbnail(AnimeF.picture)
        } catch (error) {
           AnimeScrapError.setTitle(`${FlandreUhhh} | *Sorry! I cannot find that Anime!*`)
           Reply = AnimeScrapError;
          Flandre.messageCreate(Reply, msg);
        };
        Reply = AnimeScrapSuccess;
